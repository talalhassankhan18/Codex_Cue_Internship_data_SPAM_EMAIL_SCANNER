...
model_filename = 'C:/Users/PMLS/Downloads/Spam Email Scanner/Model/spam_classifier_model.h5'
model = tf.keras.models.load_model(model_filename)

# Load the vectorizer
vectorizer_filename = 'C:/Users/PMLS/Downloads/Spam Email Scanner/Model/vectorizer.pkl'
with open(vectorizer_filename, 'rb') as file:
    vectorizer = pickle.load(file)

# Streamlit app configuration
st.set_page_config(page_title="Spam Email Scanner", page_icon="📧", layout="wide")
...
with col1:
    st.markdown('<h1 class="title">📧 Spam Email Scanner</h1>', unsafe_allow_html=True)
